...
2.  Caveats: Using a random 6 years window might end up with low variability on responses. Using many time windows or selecting specific time windows (e.g. declining) might solve this. Intuition was correct, we are doing all 6 years time window slices now.
